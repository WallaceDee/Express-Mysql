var sqlMapping = {
    ...
    list: 'SELECT a.commentId,a.content,a.authorNickName,a.createTime,b.userNickName,b.userAvatar FROM table_comment a LEFT JOIN table_user b ON(a.authorId=b.userId)  WHERE articleId=? ORDER BY a.createTime  desc LIMIT ?,?'
}
