var sqlMapping = {
    ...
    login: 'SELECT userId,userName,userNickName,userAvatar,signature,userPhone,userBirthday,userGender,createTime FROM table_user WHERE userName=? AND userPassword =?',
